...
import { getTwilightTimes, getPlanetEvents, getMoonEvent } from '../engine/astro.js';
...
function renderEventCards(container: HTMLElement, events: CelestialEvent[]): void {
...
function isShowerActive(s: { startMonth: number; startDay: number; endMonth: number; endDay: number }, m: number, d: number): boolean {
