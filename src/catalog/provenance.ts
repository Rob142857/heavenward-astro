...
export const CATALOG_PROVENANCE: CatalogProvenance[] = [
  ...
  },
  {
    ...
    upstreams: [
      ...
      {
        name: "Aboriginal Australian astronomy scholarship",
        url: "http://www.narit.or.th/en/files/JAHH.html",
        maintainer: "Hamacher, Frew, Fuller, Anderson, Norris, Leaman et al.",
        license: "Peer-reviewed: Journal of Astronomical History and Heritage; The Australian Journal of Anthropology",
        role: "Sources for the Boorong record of Eta Carinae's eruption, the Kamilaroi/Euahlayi Emu in the Sky, and the Kokatha and Ngarrindjeri red-star traditions — community-involved research over 19th-century primary ethnography.",
      },
      {
        name: "Elsdon Best, Māori ethnographic monographs (1922)",
        url: "https://nzetc.victoria.ac.nz/",
        maintainer: "Dominion Museum, New Zealand; online at NZETC",
        license: "Public domain",
        role: "Sources for Te Waka o Tama-rereti, Atutahi, Puanga and the Southern Cross wayfinding entries — read with stated caveats where Best's era's theories have since been set aside.",
      },
      {
        name: "Classical catasterisms: Hyginus, Aratus, Ovid",
        url: "https://www.loebclassics.com/",
        maintainer: "Trans. Grant (1960), Mair (Loeb 129), Frazer (Loeb 253)",
        license: "Ancient public-domain texts; translations cited per entry",
        role: "Sources for the Leo, Cancer, Virgo, Pisces, Sagittarius and Capricornus star-myth entries — the ancient authors' own words on how the figures reached the sky.",
      },
      {
        name: "Babylonian zodiac and iconography scholarship",
        url: "https://en.wikipedia.org/wiki/Babylonian_astronomy",
        maintainer: "John M. Steele; F. A. M. Wiggermann",
        license: "Academic scholarship, cited per entry",
        role: "Sources for the invention of the 12-sign zodiac as celestial bookkeeping and the goat-fish behind Capricornus.",
      },
      {
        name: "Chinese primary texts: Shijing, Shiji, Song Shi, Wen Xuan",
        url: "https://ctext.org/",
        maintainer: "Various; searchable at the Chinese Text Project",
        license: "Ancient public-domain texts",
        role: "Sources for the SN 1054 guest-star record, the Weaver Girl and Cowherd stars, the Purple Palace around the pole, and the Fire Star calendar of ode 154.",
      },
      {
        name: "Al-Sufi and Arabic star-name scholarship",
        url: "https://en.wikipedia.org/wiki/Book_of_Fixed_Stars",
        maintainer: "ʿAbd al-Rahman al-Sufi (964 CE); Kunitzsch & Smart",
        license: "Primary text; A Dictionary of Modern Star Names (Sky Publishing, 2006)",
        role: "Sources for al-Sufi's record of the Andromeda Galaxy and the etymologies of Betelgeuse, Vega, Algol, Fomalhaut and Deneb.",
      },
      {
        name: "Taittiriya Samhita 4.4.10; Priskin (2019)",
        url: "https://en.wikipedia.org/wiki/Nakshatra",
        maintainer: "Vedic corpus; Gyula Priskin, ENiM 12",
        license: "Ancient text; open-access Egyptology journal",
        role: "Sources for the Krittika nakshatra entry and the reread star-figure on Senenmut's tomb ceiling.",
      },
    ],
    gratitude:
